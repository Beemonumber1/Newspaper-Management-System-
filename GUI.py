...
class GUI:
    def __init__(self, root, account):
        ...
        self.save_news = Button(self.frame_left, text="Save News", highlightthickness=0, bg="#A0BCC2", command=self.save_data,bd=0).place(x=33, y=464, width=175, height=36)
        self.update_news = Button(self.frame_left, text="Update News", highlightthickness=0, bg="#A0BCC2", command=self.update_data,bd=0).place(x=33, y=520, width=175, height=36)
        self.delete_news = Button(self.frame_left, text="Delete News", highlightthickness=0, bg="#A0BCC2", command=self.delete_data,bd=0).place(x=33, y=577, width=175, height=36)
        self.reset_news = Button(self.frame_left, text="Reset News", highlightthickness=0, bg="#A0BCC2",command=self.delete_all_data,bd=0).place(x=33, y=400, width=175, height=36)
        ...
        self.search_news = Button(self.frame_right, text="Search", highlightthickness=0, bg="#db6060",fg="#000000", command=self.search_data,bd=0).place(x=80, y=76, width=70, height=30)
        ...
        Label(self.frame_right, text="Newspaper Management System", highlightthickness=0, font=('Century Gothic', 20)).place(x=180, y=23)
